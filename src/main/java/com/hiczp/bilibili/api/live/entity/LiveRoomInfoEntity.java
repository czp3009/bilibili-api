...
public class LiveRoomInfoEntity {
    ...
    public void setData(LiveRoomEntity data) {
        this.data = data;
    }
    ...
    public static class LiveRoomEntity {
        ...
        private GuardInfoEntity guardInfo;
        ...
        private List<RoomgiftsEntity> roomgifts;
        ...
        public GuardInfoEntity getGuardInfo() {
            return guardInfo;
        }
        ...
        public void setHotWord(List<HotWordEntity> hotWord) {
            this.hotWord = hotWord;
        }

        public List<RoomgiftsEntity> getRoomgifts() {
            return roomgifts;
        }

        public void setRoomgifts(List<RoomgiftsEntity> roomgifts) {
            this.roomgifts = roomgifts;
        }

        public List<IgnoreGiftEntity> getIgnoreGift() {
            return ignoreGift;
        }

        public void setIgnoreGift(List<IgnoreGiftEntity> ignoreGift) {
        ...
        public static class MetaEntity {
            ...
            public TagIdsEntity getTagIds() {
                return tagIds;
            }

            public void setTagIds(TagIdsEntity tagIds) {
                this.tagIds = tagIds;
            }
            ...
            public static class TagIdsEntity {
                /**
                 * 0 : 24
                 */
        ...
        public static class GuardInfoEntity {
            /**
             * heart_status : 0
             * heart_time : 300
             */
        ...
        public static class RoomgiftsEntity {
            ...
            private CoinTypeEntity coinType;
            @SerializedName("img")
            private String img;
            ...
            public CoinTypeEntity getCoinType() {
                return coinType;
            }

            public void setCoinType(CoinTypeEntity coinType) {
            ...
            public static class CoinTypeEntity {
                /**
                 * gold : gold
                 */
